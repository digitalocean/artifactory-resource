...
BUILD_DIR := build
DOCKER_REPO := digitalocean/artifactory-resource
BINARY := check
EXTENSION :=
...
.PHONY: test
test:
	@go test --cover github.com/digitalocean/artifactory-resource/...
...
.PHONY: docker-push
docker-push:
	@docker push digitalocean/artifactory-resource:dev
